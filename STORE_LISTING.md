...
- Notizen, Zitate, Aufgaben und Zusammenfassungen direkt pro Quelle
- BibTeX-Export für wissenschaftliche Schreibworkflows
- read-only Companion-Export `litzentrum-library-v1.json` für Web/PWA-Nutzung
...
- Menschen, die Metadaten, Zitate und Aufgaben mobil nachschlagen wollen, ohne
  ihre PDFs oder kompletten Projektordner hochzuladen
...
### Datenschutz
https://github.com/doc-bricks/LitZentrum/blob/master/PRIVACY_POLICY.md
...
- notes, quotes, tasks, and summaries directly attached to each source
- BibTeX export for academic writing workflows
- read-only companion export `litzentrum-library-v1.json` for Web/PWA readers
...
- people who want to review metadata, quotes, and tasks on mobile without
  uploading PDFs or entire project folders
